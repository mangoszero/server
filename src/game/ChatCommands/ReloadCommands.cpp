...
bool ChatHandler::HandleReloadLootTemplatesCreatureCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(creature) loot_template`)");
    LoadLootTemplates_Creature();
    LootTemplates_Creature.CheckLootRefs(LOOT_TYPE_CREATURE, &ids_set);
    SendGlobalSysMessage("DB table `(creature) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesDisenchantCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(disenchant) loot_template`)");
    LoadLootTemplates_Disenchant();
    LootTemplates_Disenchant.CheckLootRefs(LOOT_TYPE_DISENCHANT, &ids_set);
    SendGlobalSysMessage("DB table `(disenchant) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesFishingCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(fishing) loot_template`)");
    LoadLootTemplates_Fishing();
    LootTemplates_Fishing.CheckLootRefs(LOOT_TYPE_FISHING, &ids_set);
    SendGlobalSysMessage("DB table `(fishing) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesGameobjectCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(gameobject) loot_template`)");
    LoadLootTemplates_Gameobject();
    LootTemplates_Gameobject.CheckLootRefs(LOOT_TYPE_GAMEOBJECT, &ids_set);
    SendGlobalSysMessage("DB table `(gameobject) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesItemCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(item) loot_template`)");
    LootTemplates_Item.CheckLootRefs(LOOT_TYPE_ITEM, &ids_set);
    SendGlobalSysMessage("DB table `(item) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesPickpocketingCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(pickpocketing) loot_template`)");
    LootTemplates_Pickpocketing.CheckLootRefs(LOOT_TYPE_PICKPOCKETING, &ids_set);
    SendGlobalSysMessage("DB table `(pickpocketing) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesMailCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(mail) loot_template`)");
    LoadLootTemplates_Mail();
    LootTemplates_Mail.CheckLootRefs(LOOT_TYPE_MAIL, &ids_set);
    SendGlobalSysMessage("DB table `(mail) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesReferenceCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(reference) loot_template`)");
    LoadLootTemplates_Reference();
    LootTemplates_Reference.CheckLootRefs(LOOT_TYPE_REFERENCE, &ids_set);
    SendGlobalSysMessage("DB table `(reference) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesSkinningCommand(char* /*args*/)
{
    ...
    sLog.outString("Re-Loading Loot Tables... (`(skinning) loot_template`)");
    LootTemplates_Skinning.CheckLootRefs(LOOT_TYPE_SKINNING, &ids_set);

    SendGlobalSysMessage("DB table `(skinning) loot_template` reloaded.", SEC_MODERATOR);
    return true;
}
