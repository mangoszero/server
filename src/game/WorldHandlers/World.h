...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_ANTICHEAT_ACTION,
    CONFIG_UINT32_ANTICHEAT_SPEED_TOL,
    CONFIG_UINT32_ANTICHEAT_TELE_DIST,
    CONFIG_UINT32_ANTICHEAT_SCORE_WARN,
    CONFIG_UINT32_ANTICHEAT_SCORE_RUBBER,
    CONFIG_UINT32_ANTICHEAT_SCORE_KICK,
    CONFIG_UINT32_ANTICHEAT_DECAY,
    CONFIG_UINT32_ANTICHEAT_CAST_BURST,
    CONFIG_UINT32_ANTICHEAT_ACCEL_MULT,
    // Anti-Cheat time-sync subsystem
    CONFIG_UINT32_TIMESYNC_ALPHA,
    CONFIG_UINT32_TIMESYNC_DESYNC,
    CONFIG_UINT32_TIMESYNC_MAX_SKIP,
    CONFIG_UINT32_TIMESYNC_RESYNC_TRIPS,
    CONFIG_UINT32_TIMESYNC_RESYNC_COOLDOWN,
    // Anti-Cheat anti-gaming autoban
    CONFIG_UINT32_AC_AUTOBAN_KICKPOINTS,
    CONFIG_UINT32_AC_AUTOBAN_THRESHOLD,
    CONFIG_UINT32_AC_AUTOBAN_DECAY_PER_HOUR,
    CONFIG_UINT32_AC_AUTOBAN_DUR1,
    CONFIG_UINT32_AC_AUTOBAN_DUR2,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ANTICHEAT_MOVEMENT,
    CONFIG_BOOL_ANTICHEAT_PHYSICS,
    CONFIG_BOOL_ANTICHEAT_EXEMPT_BOTS,
    CONFIG_BOOL_ANTICHEAT_PERSIST,
    CONFIG_BOOL_ANTICHEAT_ACCEL_CHECK,
    CONFIG_BOOL_ANTICHEAT_BOT_DETECT,
    CONFIG_BOOL_AC_AUTOBAN_ENABLE,
    // Anti-Cheat time-sync subsystem
    CONFIG_BOOL_TIMESYNC_ENABLE,
    CONFIG_BOOL_TIMESYNC_AUTORESYNC,
    CONFIG_BOOL_TIMESYNC_MOVE_CORRECTION,
